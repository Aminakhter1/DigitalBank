...
export default function Navbar() {
  ...
  return (
    <>
      <div
        className=" bg-white fixed z-50 top-0 w-full transition-all duration-300 ease-in-out"
      >
        <nav className="max-w-[1800px] w-full mx-auto px-4 sm:px-10 md:px-12 py-2 md:py-4 flex justify-between items-center z-20">
          <div className="max-w-[200px]">
            <span style={{border:"8px solid blue ",backgroundColor:"black",color:"white",padding:"4px",tabSize:"2rem",borderRadius:"20px 0px 20px 0px",boxShadow:"4px 4px 3px 3px orange"}}>Digital-Bank</span>
          </div>
